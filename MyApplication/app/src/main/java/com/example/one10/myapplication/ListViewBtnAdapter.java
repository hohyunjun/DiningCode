...
public class ListViewBtnAdapter extends ArrayAdapter implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ImageView iconImageView = (ImageView) convertView.findViewById(R.id.imageView11);
        final TextView textTextView = (TextView) convertView.findViewById(R.id.textView12);
